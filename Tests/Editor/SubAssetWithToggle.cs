...
namespace Oddworm.EditorFramework.Tests.ScriptableObjectContainerTest
{
    ...
    [CreateSubAssetMenu(typeof(ScriptableObjectContainer), menuName = "ScriptableObjectContainer Tests/SubAsset With Toggle")]
#endif
    internal class SubAssetWithToggle : ScriptableObject
    {
        [SubAssetToggle]
        [SerializeField] bool m_MyToggle;
    }
}
